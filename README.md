...
Continue the casting-gesture audit with Agony/Torment, then other class signatures. Their direct activation methods contain effects/particles/sounds but no gesture dispatch; inspect shared activation and effect callbacks before adding animations. Keep successful casting gestures once per activation and leave failed casts unchanged.

...
- Debugger state: completed damage/tier probes removed. Two RighteousShieldEffect probes prepared: healing-tier release (line 40) records stack count and nearby shield_heal_test wolf health; final effect tick (line 54) records wolf health and remaining Aegis. Next: summon an injured test wolf, assign its owner to the player, seed exactly 10 Aegis stacks and cast through it. Ten-stack selection/healing, fifteen-stack behavior, blocking and cap remain pending. Old Magic Circle probe remains user-owned.

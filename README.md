...
- Righteous Shield first trace at 30 points verified passive Golden Aegis gain at player ticks 1200 and 1600, successful casts with one stack, base projectile branch (amplifier 0 at duration 10), and complete consumption of that stack. Cast attempts without Aegis also captured. User reports shield bouncing into the distance; whether it bounced off terrain or an enemy remains unclear, and enemy ricochet/damage are not yet verified. Base projectile config has bounce 5, ricochet 2, range 32 and velocity 3.6. Other tiers, blocking trigger and cap remain pending.

...
- Debugger state: Client running with the consumption fix. RighteousShieldEffect line 63 records actual stacks and tier cost; line 54 records remaining Aegis immediately after dispatch/consumption, before passive regeneration can interfere. Exact fifteen- and ten-stack depletion passed. Next: seed exactly five stacks and cast; blocking/cap remain pending. Final-tier damage and Death Mark are verified; shared Death Mark mechanics need no repeat. Old Magic Circle probe remains user-owned.

...
- Debugger state: Client running with the consumption fix; consumption probes removed. PlayerEntityMixin lines 63/65 now record Aegis before/after shield blocking, with spent points and attacker at entry. Next: seed 17 stacks, block several melee zombie hits with a normal shield in Survival, and verify gain to 18 plus cap retention. Larger final-tier visual still needs user confirmation. Old Magic Circle probe remains user-owned.

...
- Ghostwalk in progress at 30 spent points: starts at 60 ticks (3 seconds) with Soulshock IV. Eight paired hits captured; raw damage 8.7125, first zombie health 14 to 5.4269 after mitigation. First heal raised player health 12.965332 to 17.321583 (+4.356251, half raw damage); next hit reached the 20-health cap. Expiration reached the gravity-reset statement. No current probe evaluation errors; earlier invalid line-75 probe was removed before this run. Wither retest confirmed Wither was active at Ghostwalk start (149 ticks remaining) and expiration health was 13, but the mixin cancellation probe produced no output. This alone does not establish success or failure; invulnerability and visual movement/recovery confirmation remain pending. Expanded the effect-tick probe to sample health every 10 ticks and at the final tick if a repeat is needed.
...
- Debugger state: completed Torment and Chainbreaker probes removed. Ghostwalk probes prepared for starting effects/points, paired damage and healing, incoming damage cancellation, and expiration. Damage/healing verified; retain probes for the pending invulnerability and movement/recovery check. Old Magic Circle probe remains user-owned.

Current test: Ghostwalk. Selection commands for resuming:

```mcfunction
/puffish_skills category unlock @s simplyskills:ascendancy
/puffish_skills skills lock @s simplyskills:ascendancy c97wxgqn3utj7y01
/puffish_skills skills unlock @s simplyskills:ascendancy n04zw9wy6wtnbcs6
```

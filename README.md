...
- Debugger state: completed Ghostwalk probes removed. Rapidfire probes prepared for duration, held weapon, arrow count and Marksmanship. Bow and modded crossbow duration/Marksmanship cadence verified. Keep probes until remaining checks are resolved. Old Magic Circle probe remains user-owned.

...
| Ranger | Disengage: leap only, hand gesture removed at user request (build passed; loads on next restart); Elemental Arrows: healing/enchantment release; Arrow Rain: upward archery release |

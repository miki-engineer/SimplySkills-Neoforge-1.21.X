...
- **Current gameplay test: Magic Circle.** Base activation passed on this computer at 1 spent Ascendancy point: debugger recorded 241 ticks and Immobilize; user confirmed the visible circle, movement restriction, and movement returning afterward. Next verify the 30% spell-power bonus with before/after attribute probes, then 30-point duration (270 ticks) and Spell Echo interactions. Those checks remain pending.

...
- Debugger state: completed Arcane Slash and tagged-target damage probes removed. An old Magic Circle probe remains in this IDE as user-owned. Prepare fresh Agony probes before testing.

...
- Berserker
- Spellblade
- Ranger base passives, Disengage branch, and Arrow Rain branch

Still in progress:

- Ranger Elemental Arrows branch
- Rogue
- Wizard
- Necromancer
- Ascendancy tree
...
- Ranger Elemental Arrows, Rogue, Wizard, Necromancer, and Ascendancy testing still remain.

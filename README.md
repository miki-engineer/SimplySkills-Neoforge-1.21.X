...
- Debugger state: completed Agony probes removed. Torment probes at AscendancyAbilities.java lines 169, 185 and 186 capture curse/taunt application and damage redirection before/after. An old Magic Circle probe remains as user-owned. Torment results pending.

To switch the current Agony setup to Torment:

```mcfunction
/puffish_skills category unlock @s simplyskills:ascendancy
/puffish_skills skills lock @s simplyskills:ascendancy ryy2kyag7c7irtmf
/puffish_skills skills unlock @s simplyskills:ascendancy ntkotv5t9pxmo20r
```

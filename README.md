...
- Debugger handoff: all agent probes removed; user-owned probes retained. Prepare Cataclysm probes before the first cast. Arrow blocks do not invoke the current melee-only Aegis hook; no behavior change made.

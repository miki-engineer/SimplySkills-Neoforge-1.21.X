...
- Debugger state: completed Ghostwalk probes removed. Rapidfire probes prepared for duration, held weapon, arrow count and Marksmanship. Next: bow test at 30 spent points (expected 150 ticks), movement/action recovery and every-third-arrow upgrade, then crossbow. Runtime checks remain pending. Old Magic Circle probe remains user-owned.

Next test: Rapidfire. Switch from Ghostwalk:

...
- Debugger state: completed shield probes removed. Next: close/restart Client to load the shield consumption fix, then probe exact-tier casts for zero remaining Aegis (watch passive regeneration separately). Final-tier damage and Death Mark are verified; shared Death Mark mechanics need no repeat. Old Magic Circle probe remains user-owned.

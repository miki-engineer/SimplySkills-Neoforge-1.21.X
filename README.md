...
- Bone Armor scaling follow-up: a cast recorded 11 spent Ascendancy points (not the requested 10), amplifier 4 (5 layers), 800 ticks, armor 13, and toughness 3.0, from a baseline of armor 8/toughness 2.0. This verifies scaling within the 10–19-point band, not the exact 9-to-10 boundary. The next cast confirmed exactly 20 spent points, amplifier 5 (6 layers), 800 ticks, armor 14, and toughness 3.2. Next check: 30 spent points for 7 layers, then consume the layers with isolated damage and verify Undying and Regeneration for 160 ticks. A non-suspending probe is prepared after the final-layer effect additions in `BoneArmorEffect.onEffectRemovedCustom`. The 30-point check and exact threshold transitions remain unverified.

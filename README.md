...
- Debugger state: healing probes removed after verification. RighteousShieldEffect line 37 records final-tier stacks and shield_final_test zombie health before release; line 54 records health, active effects and remaining Aegis on the final effect tick. Next: summon one tagged NoAI zombie, equip a helmet, seed 15 Aegis stacks and cast once from a few blocks away. Final-tier model is larger and should apply Death Mark; runtime checks pending. Old Magic Circle probe remains user-owned.

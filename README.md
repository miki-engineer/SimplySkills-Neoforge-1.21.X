...
- **Current gameplay test: Magic Circle.** Base activation passed at 1 spent Ascendancy point: 241 ticks and Immobilize, with user-confirmed circle and movement recovery. The 30% bonus passed for all six schools: Soul 2.016 -> 2.6208, Lightning 2 -> 2.6, Healing 6 -> 7.8, and Arcane/Fire/Frost 1.2 -> 1.56. The 30-point duration also passed after restart: the debugger recorded 30 points, 270 ticks (13.5 seconds), and Immobilize. The user visually confirmed the healing gesture. Spell Echo was reached with the Wizard passive locked and Magic Circle active at 30 points; a successful roll selected fire_arrow against a skeleton. With the Wizard passive unlocked, runtime chance was 15% outside Magic Circle and 25% inside, with successful bonus-spell selections in both states. Remaining discrepancy: the locked-passive case also received 25%; the tooltip reserves the extra 10 percentage points for players who already own Spell Echo. Correct that bonus gate and retest the locked-passive case at 15%. Completed Magic Circle probes were removed. Before/after power probes were removed.

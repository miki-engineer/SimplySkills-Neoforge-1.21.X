...
Buff-particle preview added to 15 activations: Berserker three signatures (rage); Rogue three, Elemental Arrows, Elemental Surge/Spellweaver and Magic Circle (arcane); Anoint Weapon, Consecration, Righteous Hammers and Chainbreaker (holy); Bone Armor (skull). Each server activation sends one 20-particle outward ring and 12 rising sparks using Spell Engine particle types; no repeating aura or gameplay change. Sacred Onslaught hand gesture removed. Installed particle API inspected; IntelliJ compilation and Gradle build passed. Pending after restart: preview Anoint Weapon and Consecration, confirm ring/rising motion, visibility and acceptable density, then sample rage/arcane/skull themes. All new particle visuals and multiplayer visibility are unverified.

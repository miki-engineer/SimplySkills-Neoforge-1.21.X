...
- Debugger state: completed Torment and Chainbreaker probes removed. Ghostwalk probes prepared for starting effects/points, paired damage and healing, incoming damage cancellation, and expiration. Gameplay checks remain pending; verify forward motion, recovery, and the 30-point healing upgrade. Old Magic Circle probe remains user-owned.

Next test: Ghostwalk. Switch from Chainbreaker:

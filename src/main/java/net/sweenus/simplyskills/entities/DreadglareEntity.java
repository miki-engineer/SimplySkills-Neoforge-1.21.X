...
public class DreadglareEntity extends TamableAnimal implements NeutralMob, FlyingAnimal {
    ...
    public boolean doHurtTarget(Entity target) {
        ...
        if (this.getOwner() != null && this.getOwner() instanceof Player player) {
            ...
            float siphonAmount = (float) this.getAttributeValue(Attributes.ATTACK_DAMAGE) * 0.3f;
        ...
        this.level().playSound(null, this, SoundRegistry.MAW,
                SoundSource.PLAYERS, 0.1f, 1.3f + random);

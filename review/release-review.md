...
- **Post-removal smoke checks: PASS.** Bone Armor, Chainbreaker, Cyclonic Cleave, Skill Chronicle XP/build restoration and both manuscripts passed at the recorded scopes. Projectile visual smoke checks are user-confirmed. Packaged-JAR installation, world loading, UI and Arcane Bolt are also user-confirmed. Standalone packaged-server startup, two-player login, visibility, ally healing/buffs, friendly fire and focused curse/Ghostwalk isolation passed. Rapidfire counter sharing was found, fixed and verified after restart; see the central verification record.
